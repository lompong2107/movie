...
<body>
    ...
    <div class="home-section">
        <nav class="navbar navbar-dark bg-dark home-content w-100 text-white">
            <ul class="navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <span class="h3" id="text-title">เพิ่มโปรโมชั่น</span>
                </li>
            </ul>
        </nav>
        <div class="content py-3" id="content">
            <div class="mx-auto border" style="width: 700px;">
                ...
                <form id="pro_form_add" method="POST" enctype="multipart/form-data">
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                            <label for="pro_title" class="col-form-label">หัวข้อ</label>
                        </div>
                        <div class="col-6">
                            <input type="text" name="pro_title" id="pro_title" class="form-control" required>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-6">
                            <textarea name="pro_detail" id="pro_detail" class="form-control" rows="4" required></textarea>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                        ...
                        <div class="col-6">
                            <input type="date" name="pro_date_start" id="pro_date_start" class="form-control" min="<?= date("Y-m-d"); ?>" required>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                        ...
                        <div class="col-6">
                            <input type="date" name="pro_date_end" id="pro_date_end" class="form-control" min="<?= date("Y-m-d"); ?>" required>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                        ...
                        <div class="col-6">
                            <input type="file" onchange="previewFile(this);" name="pro_image" id="pro_image" class="form-control" accept=".png, .jpg, .jpeg" required>
                        </div>
                        <div class="col-4">
    ...
    <script>
        $(document).ready(function() {
            // ! ฟอร์มเพิ่มข้อมูล
            $("#pro_form_add").submit(function(e) {
                e.preventDefault();
                var dataForm = new FormData(this);
                dataForm.append("submit", "proAdd");
                $.ajax({
                    type: "POST",
                            ...
                            $.confirm({
                                ...
                                buttons: {
                                    confirm: {
                                        text: 'ตกลง',
                                        action: function() {
                                            window.location = "promotionAdd.php";
                                        }
                                    },
                                    back: {
                                        text: 'กลับ',
