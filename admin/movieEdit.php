...
$sql = "SELECT * FROM movies WHERE mov_id = " . $_GET["id"];
...
<body>
    ...
    <div class="home-section">
        <nav class="navbar navbar-dark bg-dark home-content w-100 text-white">
            <ul class="navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <span class="h3" id="text-title">แก้ไขภาพยนตร์</span>
                </li>
            </ul>
        </nav>
        <div class="content py-3" id="content">
            <div class="mx-auto border" style="width: 700px;">
                ...
                <form id="mov_form_edit" method="POST" enctype="multipart/form-data">
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                            <label for="mov_name" class="col-form-label">ชื่อภาพยนตร์</label>
                        </div>
                        <div class="col-6">
                            <input type="text" name="mov_id" id="mov_id" value="<?= $_GET['id']; ?>" hidden>
                            <input type="text" name="mov_name" id="mov_name" class="form-control" value="<?= $result["mov_name"]; ?>" required>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                        ...
                        <div class="col-6">
                            <input type="text" name="mov_actor" id="mov_actor" class="form-control" value="<?= $result["mov_actor"]; ?>" required>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-6">
                            <input type="text" name="mov_superintendent" id="mov_superintendent" class="form-control" value="<?= $result["mov_superintendent"]; ?>" required>
                        </div>
                        <div class="col-4">
                            <span class="form-text">
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-6">
                            <textarea name="mov_details" id="mov_details" class="form-control" rows="4" required><?= $result["mov_details"]; ?></textarea>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                        ...
                        <div class="col-6">
                            <input type="number" name="mov_time" id="mov_time" class="form-control" value="<?= $result["mov_time"]; ?>" required>
                        </div>
                        <div class="col-4">
                            <span class="form-text">
                                นาที
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-6">
                            <select class="form-select" name="mov_type_id" id="mov_type_id" required>
                                ...
                                ?>
                                    <option value="<?= $row["mov_type_id"]; ?>" <?php if ($result["mov_type_id"] == $row["mov_type_id"]) echo "selected" ?>><?= $row["mov_type_name"]; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-6">
                            <input type="date" name="mov_date_start" id="mov_date_start" class="form-control" value="<?= $result["mov_date_start"]; ?>" required>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                        ...
                        <div class="col-6">
                            <input type="date" name="mov_date_end" id="mov_date_end" class="form-control" value="<?= $result["mov_date_end"]; ?>" required>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                        ...
                        <div class="col-6">
                            <input type="file" onchange="previewFile(this);" name="mov_picture" id="mov_picture" class="form-control" accept=".png, .jpg, .jpeg">
                        </div>
                        <div class="col-4">
                            <span class="form-text">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        <img src="../image/movie/<?= $result["mov_picture"]; ?>" id="imagepreview" style="width: 200px;">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            // ! ฟอร์มแก้ไขข้อมูลภาพยนตร์
            $("#mov_form_edit").submit(function(e) {
                e.preventDefault();
                var dataForm = new FormData(this);
                dataForm.append("submit", "movEdit");
                $.ajax({
                    type: "POST",
