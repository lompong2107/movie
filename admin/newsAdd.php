...
<body>
    ...
    <div class="home-section">
        <nav class="navbar navbar-dark bg-dark home-content w-100 text-white">
            <ul class="navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <span class="h3" id="text-title">เพิ่มข่าวและกิจกรรม</span>
                </li>
            </ul>
        </nav>
            ...
            <div class="mx-auto border" style="width: 700px;">
                ...
                <form id="new_form_add" method="POST" enctype="multipart/form-data">
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-6">
                            <input type="text" name="new_title" id="new_title" class="form-control" required>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-6">
                            <textarea name="new_detail" id="new_detail" class="form-control" rows="4" required></textarea>
                        </div>
                    </div>
                    <div class="row align-items-center mb-3">
                        <div class="col-2 text-end">
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-6">
                            <input type="file" onchange="previewFile(this);" name="new_image" id="new_image" class="form-control" accept=".png, .jpg, .jpeg" required>
                        </div>
                        <div class="col-4">
    ...
    <script>
        $(document).ready(function() {
            // ! ฟอร์มเพิ่มข้อมูล
            $("#new_form_add").submit(function(e) {
                e.preventDefault();
                var dataForm = new FormData(this);
                dataForm.append("submit", "newAdd");
                $.ajax({
                    type: "POST",
