    ...
    <div class="home-section">
        <nav class="navbar navbar-dark bg-dark home-content w-100 text-white">
            <ul class="navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <span class="h3" id="text-title">ที่นั่ง</span>
                </li>
            </ul>
        </nav>
            ...
            <div class="container">
                <div class="row py-2">
                    <div class="col text-end">
                        <a class="btn btn-dark btn-sm" href="seatAdd.php"><i class='bx bx-plus align-middle'></i> เพิ่มที่นั่ง</a>
                    </div>
                </div>
